function Main_Time_SagittalLifting_octave(file_input, output_folder)
...
vector_data = [Time_seconds.Phase_1, Time_seconds.Phase_2, ...
                Time_seconds.Phase_3, Time_seconds.Phase_4, ...
                Time_seconds.Phase_5, Time_seconds.Sum, Time_seconds.Complete_Trial];
                
vector_labels = "'Time Phase 1', 'Time Phase 2', 'Time Phase 3', 'Time Phase 4', 'Time Phase 5', 'Time Sum', 'Time Complete Trial'"

filename = strcat(output_folder, "/", "PerformanceTime_SagittalLifting", ".yaml");
range_of_movement = store_vector_result(filename, vector_data, vector_labels);
