...
[labels_Ankle, ROM_Ankle_vector] = ROMAnkle_LBTWithout_octave(file_input);
close all
[labels_Elbow, ROM_Elbow_vector] = ROMElbow_LBTWithout_octave(file_input);
close all
[labels_Hip, ROM_Hip_vector] = ROMHip_LBTWithout_octave(file_input);
close all
[labels_Knee, ROM_Knee_vector] = ROMKnee_LBTWithout_octave(file_input);
close all
[labels_Shoulder, ROM_Shoulder_vector] = ROMShoulder_LBTWithout_octave(file_input);
close all
