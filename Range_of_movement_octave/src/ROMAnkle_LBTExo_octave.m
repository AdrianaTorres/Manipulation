function [labels_ROM, vector_ROM] = ROMAnkle_LBTExo_octave(input_path)
...
'Right_Ankle_ROM_X_Phase4', 'Right_Ankle_ROM_Y_Phase4', 'Right_Ankle_ROM_Z_Phase4', ...
'Right_Ankle_ROM_X_Phase5', 'Right_Ankle_ROM_Y_Phase5', 'Right_Ankle_ROM_Z_Phase5', ...
...
'Left_Ankle_ROM_X_Phase4', 'Left_Ankle_ROM_Y_Phase4', 'Left_Ankle_ROM_Z_Phase4', ...
'Left_Ankle_ROM_X_Phase5', 'Left_Ankle_ROM_Y_Phase5', 'Left_Ankle_ROM_Z_Phase5', ...
...
ROM_Right_Ankle.Phase4_X, ROM_Right_Ankle.Phase4_Y, ROM_Right_Ankle.Phase4_Z, ...
ROM_Right_Ankle.Phase5_X, ROM_Right_Ankle.Phase5_Y, ROM_Right_Ankle.Phase5_Z, ...
...
ROM_Left_Ankle.Phase4_X, ROM_Left_Ankle.Phase4_Y, ROM_Left_Ankle.Phase4_Z, ...
ROM_Left_Ankle.Phase5_X, ROM_Left_Ankle.Phase5_Y, ROM_Left_Ankle.Phase5_Z, ...
