function [labels_ROM, vector_ROM] = ROMElbow_LBTExo_octave(input_path)
...
labels_ROM = "'Right_Elbow_ROM_X_Phase1', 'Right_Elbow_ROM_Y_Phase1', 'Right_Elbow_ROM_Z_Phase1', ...
'Right_Elbow_ROM_X_Phase2', 'Right_Elbow_ROM_Y_Phase2', 'Right_Elbow_ROM_Z_Phase2', ...
'Right_Elbow_ROM_X_Phase3', 'Right_Elbow_ROM_Y_Phase3', 'Right_Elbow_ROM_Z_Phase3', ...
'Right_Elbow_ROM_X_Phase4', 'Right_Elbow_ROM_Y_Phase4', 'Right_Elbow_ROM_Z_Phase4', ...
'Right_Elbow_ROM_X_Phase5', 'Right_Elbow_ROM_Y_Phase5', 'Right_Elbow_ROM_Z_Phase5', ...
'Left_Elbow_ROM_X_Phase1', 'Left_Elbow_ROM_Y_Phase1', 'Left_Elbow_ROM_Z_Phase1', ...
'Left_Elbow_ROM_X_Phase2', 'Left_Elbow_ROM_Y_Phase2', 'Left_Elbow_ROM_Z_Phase2', ...
'Left_Elbow_ROM_X_Phase3', 'Left_Elbow_ROM_Y_Phase3', 'Left_Elbow_ROM_Z_Phase3', ...
'Left_Elbow_ROM_X_Phase4', 'Left_Elbow_ROM_Y_Phase4', 'Left_Elbow_ROM_Z_Phase4', ...
'Left_Elbow_ROM_X_Phase5', 'Left_Elbow_ROM_Y_Phase5', 'Left_Elbow_ROM_Z_Phase5', ...
'Right_Elbow_ROM_X_Total', 'Right_Elbow_ROM_Y_Total', 'Right_Elbow_ROM_Z_Total', ...
'Left_Elbow_ROM_X_Total', 'Left_Elbow_ROM_Y_Total', 'Left_Elbow_ROM_Z_Total'";
            
vector_ROM = [ROM_Right_Elbow.Phase1_X, ROM_Right_Elbow.Phase1_Y, ROM_Right_Elbow.Phase1_Z, ...
ROM_Right_Elbow.Phase2_X, ROM_Right_Elbow.Phase2_Y, ROM_Right_Elbow.Phase2_Z, ...
ROM_Right_Elbow.Phase3_X, ROM_Right_Elbow.Phase3_Y, ROM_Right_Elbow.Phase3_Z, ...
ROM_Right_Elbow.Phase4_X, ROM_Right_Elbow.Phase4_Y, ROM_Right_Elbow.Phase4_Z, ...
ROM_Right_Elbow.Phase5_X, ROM_Right_Elbow.Phase5_Y, ROM_Right_Elbow.Phase5_Z, ...
ROM_Left_Elbow.Phase1_X, ROM_Left_Elbow.Phase1_Y, ROM_Left_Elbow.Phase1_Z, ...
ROM_Left_Elbow.Phase2_X, ROM_Left_Elbow.Phase2_Y, ROM_Left_Elbow.Phase2_Z, ...
ROM_Left_Elbow.Phase3_X, ROM_Left_Elbow.Phase3_Y, ROM_Left_Elbow.Phase3_Z, ...
ROM_Left_Elbow.Phase4_X, ROM_Left_Elbow.Phase4_Y, ROM_Left_Elbow.Phase4_Z, ...
ROM_Left_Elbow.Phase5_X, ROM_Left_Elbow.Phase5_Y, ROM_Left_Elbow.Phase5_Z, ...
TotalROM_Elbow.Right_X, TotalROM_Elbow.Right_Y, TotalROM_Elbow.Right_Z, ...
TotalROM_Elbow.Left_X, TotalROM_Elbow.Left_Y, TotalROM_Elbow.Left_Z]; 
end