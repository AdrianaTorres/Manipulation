function [labels_ROM, vector_ROM] = ROMHip_LBTWithout_octave(input_path)
...
% +(frames/1000)
plot(t_1000,RHipAngles_x(1:(frames/1000):end_)); 
hold on 
...
figure(3)
plot(t_1000, RHipAngles_y(1:(frames/1000):end_));
hold on 
...
figure(4)
plot(t_1000, RHipAngles_z(1:(frames/1000):end_));
hold on 
...
% (1:(frames/1000):frames+(frames/1000)) si frames<1000
% +(frames/1000)
plot(t_1000,LHipAngles_x(1:(frames/1000):end_));
hold on 
plot(t_1000, flex_hip,'--',t_1000, ext_hip,'--'); 
legend({'x', 'Normal range of flexion-extension'},'Location','best');
xlabel('Time in seconds (%1000 lifting cycle)'); %tanto por mil 
...
figure(6)
plot(t_1000, LHipAngles_y(1:(frames/1000):end_));
hold on 
plot(t_1000, abd_hip,'--',t_1000, add_hip,'--'); 
legend({'y', 'Normal range of abduction-adduction'},'Location','best');
xlabel('Time in seconds (%1000 lifting cycle)'); %tanto por mil 
...
figure(7)
plot(t_1000, LHipAngles_z(1:(frames/1000):end_));
hold on 
plot(t_1000, intRot_hip,'--',t_1000, extRot_hip,'--'); 
legend({'z', 'Normal range of internal-external rotation'},'Location','best');
xlabel('Time in seconds (%1000 lifting cycle)'); %tanto por mil 
