...
labels_ROM = "'Right_Knee_ROM_X_Phase1', 'Right_Knee_ROM_Y_Phase1', 'Right_Knee_ROM_Z_Phase1', ...
'Right_Knee_ROM_X_Phase2', 'Right_Knee_ROM_Y_Phase2', 'Right_Knee_ROM_Z_Phase2', ...
'Right_Knee_ROM_X_Phase3', 'Right_Knee_ROM_Y_Phase3', 'Right_Knee_ROM_Z_Phase3', ...
'Right_Knee_ROM_X_Phase4', 'Right_Knee_ROM_Y_Phase4', 'Right_Knee_ROM_Z_Phase4', ...
'Right_Knee_ROM_X_Phase5', 'Right_Knee_ROM_Y_Phase5', 'Right_Knee_ROM_Z_Phase5', ...
'Left_Knee_ROM_X_Phase1', 'Left_Knee_ROM_Y_Phase1', 'Left_Knee_ROM_Z_Phase1', ...
'Left_Knee_ROM_X_Phase2', 'Left_Knee_ROM_Y_Phase2', 'Left_Knee_ROM_Z_Phase2', ...
'Left_Knee_ROM_X_Phase3', 'Left_Knee_ROM_Y_Phase3', 'Left_Knee_ROM_Z_Phase3', ...
'Left_Knee_ROM_X_Phase4', 'Left_Knee_ROM_Y_Phase4', 'Left_Knee_ROM_Z_Phase4', ...
'Left_Knee_ROM_X_Phase5', 'Left_Knee_ROM_Y_Phase5', 'Left_Knee_ROM_Z_Phase5', ...
'Right_Knee_ROM_X_Total', 'Right_Knee_ROM_Y_Total', 'Right_Knee_ROM_Z_Total', ...
'Left_Knee_ROM_X_Total', 'Left_Knee_ROM_Y_Total', 'Left_Knee_ROM_Z_Total'";
            
vector_ROM = [ROM_Right_Knee.Phase1_X, ROM_Right_Knee.Phase1_Y, ROM_Right_Knee.Phase1_Z, ...
ROM_Right_Knee.Phase2_X, ROM_Right_Knee.Phase2_Y, ROM_Right_Knee.Phase2_Z, ...
ROM_Right_Knee.Phase3_X, ROM_Right_Knee.Phase3_Y, ROM_Right_Knee.Phase3_Z, ...
ROM_Right_Knee.Phase4_X, ROM_Right_Knee.Phase4_Y, ROM_Right_Knee.Phase4_Z, ...
ROM_Right_Knee.Phase5_X, ROM_Right_Knee.Phase5_Y, ROM_Right_Knee.Phase5_Z, ...
ROM_Left_Knee.Phase1_X, ROM_Left_Knee.Phase1_Y, ROM_Left_Knee.Phase1_Z, ...
ROM_Left_Knee.Phase2_X, ROM_Left_Knee.Phase2_Y, ROM_Left_Knee.Phase2_Z, ...
ROM_Left_Knee.Phase3_X, ROM_Left_Knee.Phase3_Y, ROM_Left_Knee.Phase3_Z, ...
ROM_Left_Knee.Phase4_X, ROM_Left_Knee.Phase4_Y, ROM_Left_Knee.Phase4_Z, ...
ROM_Left_Knee.Phase5_X, ROM_Left_Knee.Phase5_Y, ROM_Left_Knee.Phase5_Z, ...
TotalROM_Knee.Right_X, TotalROM_Knee.Right_Y, TotalROM_Knee.Right_Z, ...
TotalROM_Knee.Left_X, TotalROM_Knee.Left_Y, TotalROM_Knee.Left_Z];  
end
