function [labels_ROM, vector_ROM] = ROMShoulder_LBTExo_octave(input_path)
...
labels_ROM = "'Right_Shoulder_ROM_X_Phase1', 'Right_Shoulder_ROM_Y_Phase1', 'Right_Shoulder_ROM_Z_Phase1', ...
'Right_Shoulder_ROM_X_Phase2', 'Right_Shoulder_ROM_Y_Phase2', 'Right_Shoulder_ROM_Z_Phase2', ...
'Right_Shoulder_ROM_X_Phase3', 'Right_Shoulder_ROM_Y_Phase3', 'Right_Shoulder_ROM_Z_Phase3', ...
'Right_Shoulder_ROM_X_Phase4', 'Right_Shoulder_ROM_Y_Phase4', 'Right_Shoulder_ROM_Z_Phase4', ...
'Right_Shoulder_ROM_X_Phase5', 'Right_Shoulder_ROM_Y_Phase5', 'Right_Shoulder_ROM_Z_Phase5', ...
'Left_Shoulder_ROM_X_Phase1', 'Left_Shoulder_ROM_Y_Phase1', 'Left_Shoulder_ROM_Z_Phase1', ...
'Left_Shoulder_ROM_X_Phase2', 'Left_Shoulder_ROM_Y_Phase2', 'Left_Shoulder_ROM_Z_Phase2', ...
'Left_Shoulder_ROM_X_Phase3', 'Left_Shoulder_ROM_Y_Phase3', 'Left_Shoulder_ROM_Z_Phase3', ...
'Left_Shoulder_ROM_X_Phase4', 'Left_Shoulder_ROM_Y_Phase4', 'Left_Shoulder_ROM_Z_Phase4', ...
'Left_Shoulder_ROM_X_Phase5', 'Left_Shoulder_ROM_Y_Phase5', 'Left_Shoulder_ROM_Z_Phase5', ...
'Right_Shoulder_ROM_X_Total', 'Right_Shoulder_ROM_Y_Total', 'Right_Shoulder_ROM_Z_Total', ...
'Left_Shoulder_ROM_X_Total', 'Left_Shoulder_ROM_Y_Total', 'Left_Shoulder_ROM_Z_Total'";
            
vector_ROM = [ROM_Right_Shoulder.Phase1_X, ROM_Right_Shoulder.Phase1_Y, ROM_Right_Shoulder.Phase1_Z, ...
ROM_Right_Shoulder.Phase2_X, ROM_Right_Shoulder.Phase2_Y, ROM_Right_Shoulder.Phase2_Z, ...
ROM_Right_Shoulder.Phase3_X, ROM_Right_Shoulder.Phase3_Y, ROM_Right_Shoulder.Phase3_Z, ...
ROM_Right_Shoulder.Phase4_X, ROM_Right_Shoulder.Phase4_Y, ROM_Right_Shoulder.Phase4_Z, ...
ROM_Right_Shoulder.Phase5_X, ROM_Right_Shoulder.Phase5_Y, ROM_Right_Shoulder.Phase5_Z, ...
ROM_Left_Shoulder.Phase1_X, ROM_Left_Shoulder.Phase1_Y, ROM_Left_Shoulder.Phase1_Z, ...
ROM_Left_Shoulder.Phase2_X, ROM_Left_Shoulder.Phase2_Y, ROM_Left_Shoulder.Phase2_Z, ...
ROM_Left_Shoulder.Phase3_X, ROM_Left_Shoulder.Phase3_Y, ROM_Left_Shoulder.Phase3_Z, ...
ROM_Left_Shoulder.Phase4_X, ROM_Left_Shoulder.Phase4_Y, ROM_Left_Shoulder.Phase4_Z, ...
ROM_Left_Shoulder.Phase5_X, ROM_Left_Shoulder.Phase5_Y, ROM_Left_Shoulder.Phase5_Z, ...
TotalROM_Shoulder.Right_X, TotalROM_Shoulder.Right_Y, TotalROM_Shoulder.Right_Z, ...
TotalROM_Shoulder.Left_X, TotalROM_Shoulder.Left_Y, TotalROM_Shoulder.Left_Z];  
end
