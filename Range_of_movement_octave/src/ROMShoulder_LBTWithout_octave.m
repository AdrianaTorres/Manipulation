function [labels_ROM, vector_ROM] = ROMShoulder_LBTWithout_octave_error(input_path)
...
% +(frames/1000)
plot(t_1000,RShoulderAngles_x(1:(frames/1000):end_)); 
hold on 
...
figure(3)
plot(t_1000, RShoulderAngles_y(1:(frames/1000):end_));
hold on 
...
figure(4)
plot(t_1000, RShoulderAngles_z(1:(frames/1000):end_));
...
% (1:(frames/1000):frames+(frames/1000)) si frames<1000
% +(frames/1000)
plot(t_1000,LShoulderAngles_x(1:(frames/1000):end_)); 
hold on 
plot(t_1000, flex_shoulder,'--',t_1000, ext_shoulder,'--'); 
legend({'x', 'Normal range of flexion-extension'},'Location','best');
xlabel('Time in seconds (%1000 lifting cycle)'); %tanto por mil 
...
figure(6)
plot(t_1000, LShoulderAngles_y(1:(frames/1000):end_));
hold on 
plot(t_1000, abd_shoulder,'--',t_1000, add_shoulder,'--'); 
legend({'y', 'Normal range of abduction-adduction'},'Location','best');
xlabel('Time in seconds (%1000 lifting cycle)'); %tanto por mil 
...
figure(7)
plot(t_1000, LShoulderAngles_z(1:(frames/1000):end_));
