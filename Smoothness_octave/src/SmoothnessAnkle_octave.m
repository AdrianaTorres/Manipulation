function [labels_Smooth, vector_Smooth] = SmoothnessAnkle_octave(input_path)
...
labels_Smooth = "'Lifting_Ankle_Right_X_SPARC', 'Lifting_Ankle_Right_X_NP', 'Lifting_Ankle_Right_X_LDLJ', ...
'Lifting_Ankle_Left_X_SPARC', 'Lifting_Ankle_Left_X_NP', 'Lifting_Ankle_Left_X_LDLJ', ...
'Lifting_Ankle_Right_Y_SPARC', 'Lifting_Ankle_Right_Y_NP', 'Lifting_Ankle_Right_Y_LDLJ', ...
'Lifting_Ankle_Left_Y_SPARC', 'Lifting_Ankle_Left_Y_NP', 'Lifting_Ankle_Left_Y_LDLJ', ...
'Lifting_Ankle_Right_Z_SPARC', 'Lifting_Ankle_Right_Z_NP', 'Lifting_Ankle_Right_Z_LDLJ', ...
'Lifting_Ankle_Left_Z_SPARC', 'Lifting_Ankle_Left_Z_NP', 'Lifting_Ankle_Left_Z_LDLJ', ...
'Lowering_Ankle_Right_X_SPARC', 'Lowering_Ankle_Right_X_NP', 'Lowering_Ankle_Right_X_LDLJ', ...
'Lowering_Ankle_Left_X_SPARC', 'Lowering_Ankle_Left_X_NP', 'Lowering_Ankle_Left_X_LDLJ', ...
'Lowering_Ankle_Right_Y_SPARC', 'Lowering_Ankle_Right_Y_NP', 'Lowering_Ankle_Right_Y_LDLJ', ...
'Lowering_Ankle_Left_Y_SPARC', 'Lowering_Ankle_Left_Y_NP', 'Lowering_Ankle_Left_Y_LDLJ', ...
'Lowering_Ankle_Right_Z_SPARC', 'Lowering_Ankle_Right_Z_NP', 'Lowering_Ankle_Right_Z_LDLJ', ...
'Lowering_Ankle_Left_Z_SPARC', 'Lowering_Ankle_Left_Z_NP', 'Lowering_Ankle_Left_Z_LDLJ'";
            
vector_Smooth = [Smoothness_Lifting_Ankle.Right_X_SPARC, Smoothness_Lifting_Ankle.Right_X_NP, Smoothness_Lifting_Ankle.Right_X_LDLJ, ...
Smoothness_Lifting_Ankle.Left_X_SPARC, Smoothness_Lifting_Ankle.Left_X_NP, Smoothness_Lifting_Ankle.Left_X_LDLJ, ...
Smoothness_Lifting_Ankle.Right_Y_SPARC, Smoothness_Lifting_Ankle.Right_Y_NP, Smoothness_Lifting_Ankle.Right_Y_LDLJ, ...
Smoothness_Lifting_Ankle.Left_Y_SPARC, Smoothness_Lifting_Ankle.Left_Y_NP, Smoothness_Lifting_Ankle.Left_Y_LDLJ, ...
Smoothness_Lifting_Ankle.Right_Z_SPARC, Smoothness_Lifting_Ankle.Right_Z_NP, Smoothness_Lifting_Ankle.Right_Z_LDLJ, ...
Smoothness_Lifting_Ankle.Left_Z_SPARC, Smoothness_Lifting_Ankle.Left_Z_NP, Smoothness_Lifting_Ankle.Left_Z_LDLJ, ...
Smoothness_Lowering_Ankle.Right_X_SPARC, Smoothness_Lowering_Ankle.Right_X_NP, Smoothness_Lowering_Ankle.Right_X_LDLJ, ...
Smoothness_Lowering_Ankle.Left_X_SPARC, Smoothness_Lowering_Ankle.Left_X_NP, Smoothness_Lowering_Ankle.Left_X_LDLJ, ...
Smoothness_Lowering_Ankle.Right_Y_SPARC, Smoothness_Lowering_Ankle.Right_Y_NP, Smoothness_Lowering_Ankle.Right_Y_LDLJ, ...
Smoothness_Lowering_Ankle.Left_Y_SPARC, Smoothness_Lowering_Ankle.Left_Y_NP, Smoothness_Lowering_Ankle.Left_Y_LDLJ, ...
Smoothness_Lowering_Ankle.Right_Z_SPARC, Smoothness_Lowering_Ankle.Right_Z_NP, Smoothness_Lowering_Ankle.Right_Z_LDLJ, ...
Smoothness_Lowering_Ankle.Left_Z_SPARC, Smoothness_Lowering_Ankle.Left_Z_NP, Smoothness_Lowering_Ankle.Left_Z_LDLJ];
