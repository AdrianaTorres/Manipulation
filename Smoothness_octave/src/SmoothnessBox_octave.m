function [labels_Smooth, vector_Smooth] = SmoothnessBox_octave(input_path)
...
%% NP
    ...
    [S_lifting_NP, locs_np] = np_octave(t2,speed_lf_np);
   
    speed_lw_np = Box_angVelocity_z_lowering_sparc(1,:);
    [S_lowering_NP, locs2_np] = np_octave(t3,speed_lw_np);
...
Smoothness_Lifting_Box.Z_SPARC=S_lifting_SPARC;
Smoothness_Lifting_Box.Z_NP=S_lifting_NP;
Smoothness_Lifting_Box.Z_LDLJ=S_lifting_LDLJ;
...
Smoothness_Lowering_Box.Z_SPARC=S_lowering_SPARC;
Smoothness_Lowering_Box.Z_NP=S_lowering_NP;
Smoothness_Lowering_Box.Z_LDLJ=S_lowering_LDLJ;

Smoothness_Lowering_Box

labels_Smooth = "'Lifting_Box_Z_SPARC', 'Lifting_Box_Z_NP', 'Lifting_Box_Z_LDLJ', ...
'Lowering_Box_Z_SPARC', 'Lowering_Box_Z_NP', 'Lowering_Box_Z_LDLJ'";
            
vector_Smooth = [Smoothness_Lifting_Box.Z_SPARC, Smoothness_Lifting_Box.Z_NP, Smoothness_Lifting_Box.Z_LDLJ, ...
Smoothness_Lowering_Box.Z_SPARC, Smoothness_Lowering_Box.Z_NP, Smoothness_Lowering_Box.Z_LDLJ];
