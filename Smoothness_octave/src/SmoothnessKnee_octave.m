function [labels_Smooth, vector_Smooth] = SmoothnessKnee_octave(input_path)
...
labels_Smooth = "'Lifting_Knee_Right_X_SPARC', 'Lifting_Knee_Right_X_NP', 'Lifting_Knee_Right_X_LDLJ', ...
'Lifting_Knee_Left_X_SPARC', 'Lifting_Knee_Left_X_NP', 'Lifting_Knee_Left_X_LDLJ', ...
'Lifting_Knee_Right_Y_SPARC', 'Lifting_Knee_Right_Y_NP', 'Lifting_Knee_Right_Y_LDLJ', ...
'Lifting_Knee_Left_Y_SPARC', 'Lifting_Knee_Left_Y_NP', 'Lifting_Knee_Left_Y_LDLJ', ...
'Lifting_Knee_Right_Z_SPARC', 'Lifting_Knee_Right_Z_NP', 'Lifting_Knee_Right_Z_LDLJ', ...
'Lifting_Knee_Left_Z_SPARC', 'Lifting_Knee_Left_Z_NP', 'Lifting_Knee_Left_Z_LDLJ', ...
'Lowering_Knee_Right_X_SPARC', 'Lowering_Knee_Right_X_NP', 'Lowering_Knee_Right_X_LDLJ', ...
'Lowering_Knee_Left_X_SPARC', 'Lowering_Knee_Left_X_NP', 'Lowering_Knee_Left_X_LDLJ', ...
'Lowering_Knee_Right_Y_SPARC', 'Lowering_Knee_Right_Y_NP', 'Lowering_Knee_Right_Y_LDLJ', ...
'Lowering_Knee_Left_Y_SPARC', 'Lowering_Knee_Left_Y_NP', 'Lowering_Knee_Left_Y_LDLJ', ...
'Lowering_Knee_Right_Z_SPARC', 'Lowering_Knee_Right_Z_NP', 'Lowering_Knee_Right_Z_LDLJ', ...
'Lowering_Knee_Left_Z_SPARC', 'Lowering_Knee_Left_Z_NP', 'Lowering_Knee_Left_Z_LDLJ'";
            
vector_Smooth = [Smoothness_Lifting_Knee.Right_X_SPARC, Smoothness_Lifting_Knee.Right_X_NP, Smoothness_Lifting_Knee.Right_X_LDLJ, ...
Smoothness_Lifting_Knee.Left_X_SPARC, Smoothness_Lifting_Knee.Left_X_NP, Smoothness_Lifting_Knee.Left_X_LDLJ, ...
Smoothness_Lifting_Knee.Right_Y_SPARC, Smoothness_Lifting_Knee.Right_Y_NP, Smoothness_Lifting_Knee.Right_Y_LDLJ, ...
Smoothness_Lifting_Knee.Left_Y_SPARC, Smoothness_Lifting_Knee.Left_Y_NP, Smoothness_Lifting_Knee.Left_Y_LDLJ, ...
Smoothness_Lifting_Knee.Right_Z_SPARC, Smoothness_Lifting_Knee.Right_Z_NP, Smoothness_Lifting_Knee.Right_Z_LDLJ, ...
Smoothness_Lifting_Knee.Left_Z_SPARC, Smoothness_Lifting_Knee.Left_Z_NP, Smoothness_Lifting_Knee.Left_Z_LDLJ, ...
Smoothness_Lowering_Knee.Right_X_SPARC, Smoothness_Lowering_Knee.Right_X_NP, Smoothness_Lowering_Knee.Right_X_LDLJ, ...
Smoothness_Lowering_Knee.Left_X_SPARC, Smoothness_Lowering_Knee.Left_X_NP, Smoothness_Lowering_Knee.Left_X_LDLJ, ...
Smoothness_Lowering_Knee.Right_Y_SPARC, Smoothness_Lowering_Knee.Right_Y_NP, Smoothness_Lowering_Knee.Right_Y_LDLJ, ...
Smoothness_Lowering_Knee.Left_Y_SPARC, Smoothness_Lowering_Knee.Left_Y_NP, Smoothness_Lowering_Knee.Left_Y_LDLJ, ...
Smoothness_Lowering_Knee.Right_Z_SPARC, Smoothness_Lowering_Knee.Right_Z_NP, Smoothness_Lowering_Knee.Right_Z_LDLJ, ...
Smoothness_Lowering_Knee.Left_Z_SPARC, Smoothness_Lowering_Knee.Left_Z_NP, Smoothness_Lowering_Knee.Left_Z_LDLJ];
