function Main_Smoothness_SagittalLifting(file_input, output_folder, task)
...
ylabel('D (cm)');
##legend({'No exoskeleton','Exoskeleton'},'Location','best');
title('Shoulder-Load Distance')      %3


filename = strcat(output_folder, "/", "SpinalLoads_", task, ".yaml");
range_of_movement = store_vector_of_vector_result(filename, L4L5_compression(1:(frames1/100):frames1), L4L5_shear(1:(frames1/100):frames1), ...
                                                  L5S1_compression(1:(frames1/100):frames1), L5S1_shear(1:(frames1/100):frames1), ...
                                                  F(1:(frames1/100):frames1), D_cm(1:(frames1/100):frames1),...
                                                  'L4L5_Compression', 'L4L5_Shear', 'L5S1_Compression', 'L5S1_Shear', 'Thorax Angles (degrees)', 'Shoulder-Load Distance (cm)');
close all
endfunction