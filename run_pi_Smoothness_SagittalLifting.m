...
if nargin != 2
  ...
  printf ("Usage:\n");
  printf ("\t./run_pi_Smoothness_SagittalLifting data_SagittalLifting.mat result_dir\n\n");
  exit(127);
endif
...
Main_Smoothness_SagittalLifting(arg_list{1}, arg_list{2})